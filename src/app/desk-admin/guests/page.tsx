                    ...
                    guests.map((guest: any, idx: number) => (
                        ...
                        >
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <span className={`px-2 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest ${guest.bookingStatus === 'CONFIRMED' ? 'bg-emerald-100 text-emerald-700' :
                                    guest.bookingStatus === 'CHECKED_IN' ? 'bg-blue-100 text-blue-700' :
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-border">
                            {guests.map((guest: any, idx: number) => (
                                <tr key={guest.id || idx} className="hover:bg-secondary/30 transition-all group">
                                    <td className="p-6">
                                    ...
                                    <td className="p-6">
                                        <span className={`px-3 py-1 rounded-full text-[10px] font-black tracking-widest uppercase ${guest.bookingStatus === 'CONFIRMED' ? 'bg-emerald-100 text-emerald-700' :
                                            guest.bookingStatus === 'CHECKED_IN' ? 'bg-blue-100 text-blue-700' :
                                                'bg-secondary text-muted-foreground'
                                            }`}>
                                            {guest.bookingStatus}
